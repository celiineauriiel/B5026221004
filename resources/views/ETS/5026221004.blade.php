...
<body>
    ...
    <section class="file" id="file">
        <h2 class="file-heading" class="section-title">Files</h2>
        <div class="file-container">
        <div class="col-6">
            <li><a href="/p1" target="_blank">Tugas HTML - Pertemuan 1</a></li>
            <li><a href="/p2a" target="_blank">Tugas CSS Link - Pertemuan 2</a></li>
            <li><a href="/p2b" target="_blank">Tugas CSS Style - Pertemuan 2</a></li>
            <li><a href="/p3" target="_blank">Tugas Linktree - Pertemuan 3</a></li>
            <li><a href="/p4" target="_blank">Tugas Bootstrap 4 Responsive - Pertemuan 4</a></li>
        </div>
        <div class="col-6">
            <li><a href="/p5" target="_blank">Tugas Layout - Pertemuan 5</a></li>
            <li><a href="/p6a" target="_blank">Tugas Javascript js1 - Pertemuan 6</a></li>
            <li><a href="/p6b" target="_blank">Tugas Javascript js2 - Pertemuan 6</a></li>
            <li><a href="/p7" target="_blank">Tugas Javascript Validation - Pertemuan 7</a></li>
            <li><a href="/p8" target="_blank">Tugas ETS Landing Page - Pertemuan 8</a></li>
        </div>
    </section>
